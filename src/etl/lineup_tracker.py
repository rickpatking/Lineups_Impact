...
class LineupTracker:
    ...
    def clean_pbp(self, playbyplay, team_id):
    ...
    def get_quarter_starters(self, playbyplay, subs, quarter, team_id):
        """
    ...
    def get_lineups(self, playbyplay, subs, team_id):
        all_lineups = []
        lineups_action_id = []
        ...
        for i in range(1, 5):
            ...
            starters = self.get_quarter_starters(playbyplay, subs, i, team_id)
